...
# Настройки для периодическр
CELERY_BEAT_SCHEDULE = {
    'calculating_the_amount': {
        'task': 'bicycle.tasks.get_amount',
        'schedule': timedelta(minutes=1)
    },
}
# Путь до папки проекта
ABSOLUTE_PATH_PROJECT = os.getenv('ABSOLUTE_PATH_PROJECT')
# venv/bin/activate
SOURCE_PATH_ACTIVATE = os.getenv('SOURCE_PATH_ACTIVATE')
